...
if g:lucius_style == "dark"
    ...
    hi Normal       guifg=#d7d7d7   guibg=#262626   ctermfg=188    ctermbg=235       gui=none      cterm=none
    ...
    " ## Text Selection ##
    hi Cursor       guifg=bg        guibg=#ffff00   ctermfg=bg     ctermbg=110       gui=none      cterm=none
    ...
    hi CursorLine   guifg=NONE      guibg=#303030   ctermfg=NONE   ctermbg=237       gui=none      cterm=none
    ...
    hi LineNr       guifg=#626262   guibg=#303030   ctermfg=241    ctermbg=236       gui=none      cterm=none
    hi CursorLineNr guifg=#ffff33   guibg=#444444   ctermfg=241    ctermbg=238       gui=none      cterm=none
...
elseif g:lucius_style == "dark_dim"
    ...
    " ## Text Selection ##
    hi Cursor       guifg=bg        guibg=#ffff00   ctermfg=bg     ctermbg=67        gui=none      cterm=none
