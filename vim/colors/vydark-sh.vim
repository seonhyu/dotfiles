...
let g:colors_name="vydark-sh"
    ...
    hi Special       guifg=#99dd99  gui=none
    hi Keyword       guifg=#99bbcc  gui=none
...
" sh 확장 
"===============
hi Identifier         guifg=#68a9fb " CDBC89
hi NonText            guifg=#525252  guibg=#282828
hi Header             guifg=#fc8fe3 " ff8888
hi MatchParen         guifg=#ffffff  gui=bold

hi link taskpaperProject Header
...
hi link markdownCodeBlock          Title
hi link markdownBold               String
hi link markdownListMarker         Constant
hi link markdownHeadingDelimiter   Header
